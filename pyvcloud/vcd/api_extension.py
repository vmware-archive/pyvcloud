...
class APIExtension(object):
    ...
    def add_service_right(self, name, description, category, bundle_key):
        """Add a new right using API extension service.

        :param str name: the name of the new right to be registered.
