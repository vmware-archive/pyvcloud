...
Usage examples:
    ...
    |   57 | add VPN tunnel                       | vca vpn add-tunnel --tunnel t1 --local-ip 107.189.123.101 --local-network routed-116 --peer-ip 192.240.158.15 --peer-network 192.168.110/24 --secret P8s3P...7v               |
