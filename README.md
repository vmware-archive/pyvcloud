...
Usage examples:
    ...
    |   28 | delete vapp                          | vca vapp delete -a coreos2                                                                                                                                                       |
    |   29 | show vapp details in XML             | vca -x vapp info -a coreos2                                                                                                                                                      |
    |   30 | deploy vapp                          | vca vapp deploy --vapp ubu                                                                                                                                                       |
    |   31 | undeploy vapp                        | vca vapp undeploy --vapp ubu                                                                                                                                                     |
    |   32 | customize vapp vm                    | vca vapp customize --vapp ubu --vm ubu --file add_public_ssh_key.sh                                                                                                              |
    |   33 | insert ISO to vapp vm                | vca vapp insert --vapp coreos1 --vm coreos1 --catalog default-catalog --media coreos1-config.iso                                                                                 |
    |   34 | eject ISO from vapp vm               | vca vapp eject --vapp coreos1 --vm coreos1 --catalog default-catalog --media coreos1-config.iso                                                                                  |
    |   35 | attach disk to vapp vm               | vca vapp attach --vapp myvapp --vm myvm --disk mydisk                                                                                                                            |
    |   36 | detach disk from vapp vm             | vca vapp detach --vapp myvapp --vm myvm --disk mydisk                                                                                                                            |
    |   37 | list independent disks               | vca vapp disk                                                                                                                                                                    |
    |   38 | create independent disk of 100GB     | vca vapp disk create --disk mydisk --size 100                                                                                                                                    |
    |   39 | delete independent disk by name      | vca vapp disk delete --disk mydisk                                                                                                                                               |
    |   40 | delete independent disk by id        | vca vapp disk delete --id bce76ca7-29d0-4041-82d4-e4481804d5c4                                                                                                                   |
    |   41 | list vms                             | vca vm                                                                                                                                                                           |
    |   42 | list vms in a vapp                   | vca vm -a ubu                                                                                                                                                                    |
    |   43 | list vms in JSON format              | vca -j vm                                                                                                                                                                        |
    |   44 | retrieve the IP of a vm              | IP=`vca -j vm -a ubu | jq -r '.vms[0].IPs[0]'` && echo $IP                                                                                                                       |
    |   45 | list networks                        | vca network                                                                                                                                                                      |
    |   46 | create network                       | vca network create --network network_name --gateway gateway_name --gateway-ip 192.168.117.1 --netmask 255.255.255.0 --dns1 192.168.117.1 --pool 192.168.117.2-192.168.117.100    |
    |   47 | delete network                       | vca network delete --network network_name                                                                                                                                        |
    |   48 | list edge gateways                   | vca gateway                                                                                                                                                                      |
    |   49 | get details of edge gateways         | vca gateway info --gateway gateway_name                                                                                                                                          |
    |   50 | set syslog server on gateway         | vca gateway set-syslog --gateway gateway_name --ip 192.168.109.2                                                                                                                 |
    |   51 | unset syslog server on gateway       | vca gateway set-syslog --gateway gateway_name                                                                                                                                    |
    |   52 | list edge gateway NAT rules          | vca nat                                                                                                                                                                          |
    |   53 | add edge gateway DNAT rule           | vca nat add --type DNAT --original-ip 107.189.93.162 --original-port 22 --translated-ip 192.168.109.2 --translated-port 22 --protocol tcp                                        |
    |   54 | add edge gateway SNAT rule           | vca nat add --type SNAT --original-ip 192.168.109.0/24 --translated-ip 107.189.93.162                                                                                            |
    |   55 | add edge gateway rules from file     | vca nat add --file natrules.yaml                                                                                                                                                 |
    |   56 | delete edge gateway NAT rule         | vca nat delete --type DNAT --original-ip 107.189.93.162 --original-port 22 --translated-ip 192.168.109.4 --translated-port 22 --protocol tcp                                     |
    |   57 | delete all edge gateway NAT rules    | vca nat delete --all                                                                                                                                                             |
    |   58 | enable edge gateway firewall         | vca fw enable                                                                                                                                                                    |
    |   59 | disable edge gateway firewall        | vca fw disable                                                                                                                                                                   |
    |   60 | display DHCP configuration           | vca dhcp                                                                                                                                                                         |
    |   61 | enable DHCP service                  | vca dhcp enable                                                                                                                                                                  |
    |   62 | disable DHCP service                 | vca dhcp disable                                                                                                                                                                 |
    |   63 | add DHCP service to a network        | vca dhcp add --network routed-211 --pool 192.168.211.101-192.168.211.200                                                                                                         |
    |   64 | delete all DHCP pools from a network | vca dhcp delete --network routed-211                                                                                                                                             |
    |   65 | list edge gateway VPN config         | vca vpn                                                                                                                                                                          |
    |   66 | enable edge gateway VPN              | vca vpn enable                                                                                                                                                                   |
    |   67 | disable edge gateway VPN             | vca vpn disable                                                                                                                                                                  |
    |   68 | add VPN endpoint                     | vca vpn add-endpoint --network d1p10-ext --public-ip 107.189.123.101                                                                                                             |
    |   69 | delete VPN endpoint                  | vca vpn del-endpoint --network d1p10-ext --public-ip 107.189.123.101                                                                                                             |
    |   70 | add VPN tunnel                       | vca vpn add-tunnel --tunnel t1 --local-ip 107.189.123.101 --local-network routed-116 --peer-ip 192.240.158.15 --peer-network 192.168.110.0/24 --secret P8s3P...7v                |
    |   71 | delete VPN tunnel                    | vca vpn del-tunnel --tunnel t1                                                                                                                                                   |
    |   72 | add local network to VPN tunnel      | vca vpn add-network --tunnel t1 --local-network routed-115                                                                                                                       |
    |   73 | add peer network to VPN tunnel       | vca vpn add-network --tunnel t1 --peer-network 192.168.115.0/24                                                                                                                  |
    |   74 | delete local network from VPN tunnel | vca vpn del-network --tunnel t1 --local-network routed-115                                                                                                                       |
    |   75 | delete peer network from VPN tunnel  | vca vpn del-network --tunnel t1 --peer-network 192.168.115.0/24                                                                                                                  |
    |   76 | show the REST calls in the command   | vca --debug vm                                                                                                                                                                   |
    |   77 | show version                         | vca --version                                                                                                                                                                    |
    |   78 | show help                            | vca --help                                                                                                                                                                       |
    |   79 | show command help                    | vca <command> --help                                                                                                                                                             |
