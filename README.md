...
`vca-cli` provides a list of examples with the `example` command:
    ...
    |    4 | login to vCloud Director standalone        | vca login email@company.com --password mypassword --type standalone --host https://p1v21-vcd.vchs.vmware.com --version 5.6 --org MyOrganization                                             |
    ...
    |   27 | create vapp with manually assigned IP      | vca vapp create --vapp myvapp --vm myvm --catalog 'Public Catalog' --template 'Ubuntu Server 12.04 LTS (amd64 20150127)' --network default-routed-network --mode manual --ip 192.168.109.25 |
    |   28 | create multiple vapps                      | vca vapp create --vapp myvapp --vm myvm --catalog 'Public Catalog' --template 'Ubuntu Server 12.04 LTS (amd64 20150127)' --network default-routed-network --mode pool --count 10            |
    |   29 | create vapp and configure vm size          | vca vapp create --vapp myvapp --vm myvm --catalog 'Public Catalog' --template 'Ubuntu Server 12.04 LTS (amd64 20150127)' --network default-routed-network --mode pool --cpu 4 --ram 4096    |
    |   30 | delete vapp                                | vca vapp delete -a coreos2                                                                                                                                                                  |
    |   31 | show vapp details in XML                   | vca -x vapp info -a coreos2                                                                                                                                                                 |
    |   32 | deploy vapp                                | vca vapp deploy --vapp ubu                                                                                                                                                                  |
    |   33 | undeploy vapp                              | vca vapp undeploy --vapp ubu                                                                                                                                                                |
    |   34 | customize vapp vm                          | vca vapp customize --vapp ubu --vm ubu --file add_public_ssh_key.sh                                                                                                                         |
    |   35 | insert ISO to vapp vm                      | vca vapp insert --vapp coreos1 --vm coreos1 --catalog default-catalog --media coreos1-config.iso                                                                                            |
    |   36 | eject ISO from vapp vm                     | vca vapp eject --vapp coreos1 --vm coreos1 --catalog default-catalog --media coreos1-config.iso                                                                                             |
    |   37 | attach disk to vapp vm                     | vca vapp attach --vapp myvapp --vm myvm --disk mydisk                                                                                                                                       |
    |   38 | detach disk from vapp vm                   | vca vapp detach --vapp myvapp --vm myvm --disk mydisk                                                                                                                                       |
    |   39 | list independent disks                     | vca vapp disk                                                                                                                                                                               |
    |   40 | create independent disk of 100GB           | vca disk create --disk mydisk --size 100                                                                                                                                                    |
    |   41 | delete independent disk by name            | vca disk delete --disk mydisk                                                                                                                                                               |
    |   42 | delete independent disk by id              | vca disk delete --id bce76ca7-29d0-4041-82d4-e4481804d5c4                                                                                                                                   |
    |   43 | list vms                                   | vca vm                                                                                                                                                                                      |
    |   44 | list vms in a vapp                         | vca vm -a ubu                                                                                                                                                                               |
    |   45 | list vms in JSON format                    | vca -j vm                                                                                                                                                                                   |
    |   46 | retrieve the IP of a vm                    | IP=`vca -j vm -a ubu | jq -r '.vms[0].IPs[0]'` && echo $IP                                                                                                                                  |
    |   47 | list networks                              | vca network                                                                                                                                                                                 |
    |   48 | create network                             | vca network create --network network_name --gateway gateway_name --gateway-ip 192.168.117.1 --netmask 255.255.255.0 --dns1 192.168.117.1 --pool 192.168.117.2-192.168.117.100               |
    |   49 | delete network                             | vca network delete --network network_name                                                                                                                                                   |
    |   50 | list edge gateways                         | vca gateway                                                                                                                                                                                 |
    |   51 | get details of edge gateways               | vca gateway info --gateway gateway_name                                                                                                                                                     |
    |   52 | set syslog server on gateway               | vca gateway set-syslog --gateway gateway_name --ip 192.168.109.2                                                                                                                            |
    |   53 | unset syslog server on gateway             | vca gateway set-syslog --gateway gateway_name                                                                                                                                               |
    |   54 | allocate external IP address in OnDemand   | vca gateway add-ip                                                                                                                                                                          |
    |   55 | deallocate external IP address in OnDemand | vca gateway del-ip --ip 107.189.93.162                                                                                                                                                      |
    |   56 | list edge gateway NAT rules                | vca nat                                                                                                                                                                                     |
    |   57 | add edge gateway DNAT rule                 | vca nat add --type DNAT --original-ip 107.189.93.162 --original-port 22 --translated-ip 192.168.109.2 --translated-port 22 --protocol tcp                                                   |
    |   58 | add edge gateway SNAT rule                 | vca nat add --type SNAT --original-ip 192.168.109.0/24 --translated-ip 107.189.93.162                                                                                                       |
    |   59 | add edge gateway rules from file           | vca nat add --file natrules.yaml                                                                                                                                                            |
    |   60 | delete edge gateway NAT rule               | vca nat delete --type DNAT --original-ip 107.189.93.162 --original-port 22 --translated-ip 192.168.109.4 --translated-port 22 --protocol tcp                                                |
    |   61 | delete all edge gateway NAT rules          | vca nat delete --all                                                                                                                                                                        |
    |   62 | enable edge gateway firewall               | vca fw enable                                                                                                                                                                               |
    |   63 | disable edge gateway firewall              | vca fw disable                                                                                                                                                                              |
    |   64 | display DHCP configuration                 | vca dhcp                                                                                                                                                                                    |
    |   65 | enable DHCP service                        | vca dhcp enable                                                                                                                                                                             |
    |   66 | disable DHCP service                       | vca dhcp disable                                                                                                                                                                            |
    |   67 | add DHCP service to a network              | vca dhcp add --network routed-211 --pool 192.168.211.101-192.168.211.200                                                                                                                    |
    |   68 | delete all DHCP pools from a network       | vca dhcp delete --network routed-211                                                                                                                                                        |
    |   69 | list edge gateway VPN config               | vca vpn                                                                                                                                                                                     |
    |   70 | enable edge gateway VPN                    | vca vpn enable                                                                                                                                                                              |
    |   71 | disable edge gateway VPN                   | vca vpn disable                                                                                                                                                                             |
    |   72 | add VPN endpoint                           | vca vpn add-endpoint --network d1p10-ext --public-ip 107.189.123.101                                                                                                                        |
    |   73 | delete VPN endpoint                        | vca vpn del-endpoint --network d1p10-ext --public-ip 107.189.123.101                                                                                                                        |
    |   74 | add VPN tunnel                             | vca vpn add-tunnel --tunnel t1 --local-ip 107.189.123.101 --local-network routed-116 --peer-ip 192.240.158.15 --peer-network 192.168.110.0/24 --secret P8s3P...7v                           |
    |   75 | delete VPN tunnel                          | vca vpn del-tunnel --tunnel t1                                                                                                                                                              |
    |   76 | add local network to VPN tunnel            | vca vpn add-network --tunnel t1 --local-network routed-115                                                                                                                                  |
    |   77 | add peer network to VPN tunnel             | vca vpn add-network --tunnel t1 --peer-network 192.168.115.0/24                                                                                                                             |
    |   78 | delete local network from VPN tunnel       | vca vpn del-network --tunnel t1 --local-network routed-115                                                                                                                                  |
    |   79 | delete peer network from VPN tunnel        | vca vpn del-network --tunnel t1 --peer-network 192.168.115.0/24                                                                                                                             |
    |   80 | show the REST calls in the command         | vca --debug vm                                                                                                                                                                              |
    |   81 | show version                               | vca --version                                                                                                                                                                               |
    |   82 | show help                                  | vca --help                                                                                                                                                                                  |
    |   83 | show command help                          | vca <command> --help                                                                                                                                                                        |
