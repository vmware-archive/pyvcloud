...
class TestUser(BaseTestCase):
    ...
    def test_0010_create_user(self):
        ...
        org = Org(TestUser._client, href=TestUser._new_org_admin_href)
        role = org.get_role_record(TestUser._vapp_user_role)
        role_href = role.get('href')

        logger.debug('Creating user with vApp User role')
        created_user = org.create_user(TestUser._org_user,
                                       "password",
                                       role_href,
                                       "Full Name",
                                       "Description",
    ...
    def test_0020_get_user(self):
        ...
        """
        org = Org(TestUser._client, href=TestUser._new_org_admin_href)
        org_user = org.get_user(TestUser._org_user)
    ...
    def test_0030_enable_user(self):
        ...
        """
        org = Org(TestUser._client, href=TestUser._new_org_admin_href)
        updated_user = org.update_user(TestUser._org_user,
                                       is_enabled=True)
    ...
    def test_0040_update_user_role(self):
        ...
        updated_user = org.update_user(TestUser._org_user,
                                       role_name=TestUser._vapp_author_role)
    ...
    def test_0050_delete_user(self):
        ...
        """
        org = Org(TestUser._client, href=TestUser._new_org_admin_href)
        org.delete_user(user_name=TestUser._org_user)
